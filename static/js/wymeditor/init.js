jQuery(function() {
	jQuery('.wymeditor').wymeditor({
		...
		postInit: function(wym) {
			...
			$(wym._doc).on('keyup', function(event) {
				var h = $(this).find('html').outerHeight();  // iframe document height
				$(wym._iframe).height(h);  // adjust iframe height
			});

			var h = $(wym._doc).find('html').outerHeight();  // iframe document height
			$(wym._iframe).height(h);  // adjust iframe height
		}
	});
